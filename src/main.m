...
bitsFrame = 120;             % quantidade de bits em um frame
...
% -----------------------------
% Demodulador
rxCodMsg_2_3_16qam = demodulador(rxSig_2_3_16qam, EbN0dB, '16-QAM', 2/3);
rxCodMsg_3_4_16qam = demodulador(rxSig_3_4_16qam, EbN0dB, '16-QAM', 3/4);
rxCodMsg_2_3_qpsk = demodulador(rxSig_2_3_qpsk, EbN0dB, 'QPSK', 2/3);
rxCodMsg_3_4_qpsk = demodulador(rxSig_3_4_qpsk, EbN0dB, 'QPSK', 3/4);
% DEBUG:
